...
//santo
/*
func (mw loggingMiddleware) PostSearch(ctx context.Context, p Search) (err error) {
  defer func(begin time.Time) {
    mw.logger.Log("method", "PostSearch", "id", p.ID, "took", time.Since(begin), "err", err)
  }(time.Now())
  return mw.next.PostSearch(ctx, p)
}
*/