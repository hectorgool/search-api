...
type Endpoints struct {
  ...
  //santo
  //PostSearchEndpoint    endpoint.Endpoint
}
...
func MakeServerEndpoints(s Service) Endpoints {
  return Endpoints{
    ...
    //santo
    //PostSearchEndpoint:    MakePostSearchEndpoint(s),
  }
}
...
//santo
// MakePostSearchEndpoint returns an endpoint via the passed service.
// Primarily useful in a server.
/*
func MakePostSearchEndpoint(s Service) endpoint.Endpoint {
  return func(ctx context.Context, request interface{}) (response interface{}, err error) {
    req := request.(postSearchRequest)
    e := s.PostSearch(ctx, req.Profile)
    return postSearchResponse{Err: e}, nil
  }
}
*/
...
func (r postSearchResponse) error() error { return r.Err }
*/